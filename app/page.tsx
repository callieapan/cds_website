    ...
    return (
        <main>
            ...
            <div className="flex items-center  justify-center mb-8">
                ...
                Hi fellow CDS Alumni and Students, this resource is created to help our community excel in interviews and land the roles that we are happy with. Please be respectful with comments and do not write anything in mean or inappropriate. Your contribution is greatly appreciated. 
                In addition, here are a few rules: <br/> <br/>
                <span className="font-bold">Anonymity:</span><br/> <br/>
                ...
                Alumni and students are responsible for adhering to any confidential agreements or NDAs they&apos;ve signed during interviews. Please exercise judgment when sharing.
                <br/> <br/>
                ...
                <br/> <br/>
                Once you submit an entry and receive an email notice from CDS alumni council with a default password to view other interview experiences, please go to the{' '} 
